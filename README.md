...
| <a name="module_ddb"></a> [ddb](#module\_ddb) | github.com/justtrackio/terraform-aws-dynamodb-table | v1.0.0 |
...
| <a name="input_redis_cpu_size"></a> [redis\_cpu\_size](#input\_redis\_cpu\_size) | The cpu size of the redis instance | `string` | `25` | no |
...
| <a name="input_redis_service_memory_size"></a> [redis\_service\_memory\_size](#input\_redis\_service\_memory\_size) | The memory size of the ECS container | `string` | `50` | no |
...
| <a name="input_use_redis"></a> [use\_redis](#input\_use\_redis) | Defines if redis is to be used or not | `bool` | `true` | no |
