...
| <a name="input_ddb_attributes"></a> [ddb\_attributes](#input\_ddb\_attributes) | Additional attributes for the DDB table | <pre>list(object({<br/>    name = string<br/>    type = string<br/>  }))</pre> | `[]` | no |
...
| <a name="input_ddb_global_secondary_indexes"></a> [ddb\_global\_secondary\_indexes](#input\_ddb\_global\_secondary\_indexes) | Describe GSIs for the table; subject to the normal limits on the number of GSIs, projected attributes, etc. | <pre>list(object({<br/>    name               = string<br/>    hash_key           = string<br/>    projection_type    = string<br/>    range_key          = optional(string)<br/>    read_capacity      = optional(number)<br/>    write_capacity     = optional(number)<br/>    non_key_attributes = optional(list(string))<br/>  }))</pre> | `[]` | no |
| <a name="input_ddb_ignore_changes_global_secondary_index"></a> [ddb\_ignore\_changes\_global\_secondary\_index](#input\_ddb\_ignore\_changes\_global\_secondary\_index) | Whether to ignore changes lifecycle to global secondary indices, useful for provisioned tables with scaling | `bool` | `false` | no |
